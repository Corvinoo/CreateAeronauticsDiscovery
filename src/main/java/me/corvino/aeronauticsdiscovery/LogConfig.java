...
public class LogConfig {
    ...
    private static final ModConfigSpec.BooleanValue LOG_PATROL = BUILDER
            .comment("Enable [PATROL] log output")
            .define("log.patrol", false);
    ...
    public static boolean logPatrol;
